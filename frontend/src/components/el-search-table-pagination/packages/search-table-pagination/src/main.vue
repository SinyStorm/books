          ...
          const validData = cacheLocalData.filter(v => {
            ...
            validParamKeys.forEach(vv => {
              if (typeof v[vv] === 'number') {
                ...
                console.log(paramFuzzy)
                console.log(paramFuzzy[vv])
                console.log(v[vv])
                console.log(mergeParams[vv])
                console.log(`/${mergeParams[vv]}/i`)
                console.log(v[vv].search(new RegExp(mergeParams[vv], 'i')))
                console.log(v[vv].search(new RegExp(mergeParams[vv], 'i')) === -1)
                valids.push(
                  paramFuzzy && paramFuzzy[vv] ? (v[vv].search(new RegExp(mergeParams[vv], 'i')) !== -1) : (v[vv] === mergeParams[vv])
                )
              }
            })
